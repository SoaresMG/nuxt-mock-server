              ...
              <div class="flex space-x-5">
                <div class="w-40">
                  ...
                  <div class="opacity-40 text-xs max-w-60">
                    For now it's the only possible preset, in the future there will be the possibility to create other presets.
                  </div>
                </div>
...
import { useEntries } from "../composables/use-entries";
...
const { entries, loadEntries, isLoading } = useEntries();
